package com.utkarshambassadorfsmnew.features.logoutsync.presentation
...
import com.utkarshambassadorfsmnew.app.AppDatabase
...
import com.utkarshambassadorfsmnew.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.utkarshambassadorfsmnew.features.billing.api.AddBillingRepoProvider
import com.utkarshambassadorfsmnew.features.billing.model.AddBillingInputParamsModel
...
import com.utkarshambassadorfsmnew.features.dashboard.presentation.ReasonDialog
...
import com.utkarshambassadorfsmnew.features.document.model.AddEditDocumentInputParams
import com.utkarshambassadorfsmnew.features.document.model.DocumentAttachmentModel
...
import com.utkarshambassadorfsmnew.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.utkarshambassadorfsmnew.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.utkarshambassadorfsmnew.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.utkarshambassadorfsmnew.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.utkarshambassadorfsmnew.features.orderhistory.model.*
...
import com.utkarshambassadorfsmnew.features.quotation.model.AddQuotInputModel
import com.utkarshambassadorfsmnew.features.shopdetail.presentation.api.EditShopRepoProvider
import com.utkarshambassadorfsmnew.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.utkarshambassadorfsmnew.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.utkarshambassadorfsmnew.features.stock.api.StockRepositoryProvider
import com.utkarshambassadorfsmnew.features.stock.model.AddStockInputParamsModel
import com.utkarshambassadorfsmnew.features.stockAddCurrentStock.AddShopStockFragment
import com.utkarshambassadorfsmnew.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.utkarshambassadorfsmnew.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.utkarshambassadorfsmnew.features.timesheet.model.AddTimeSheetInputModel
import com.utkarshambassadorfsmnew.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.utkarshambassadorfsmnew.features.viewAllOrder.model.AddOrderInputParamsModel
import com.utkarshambassadorfsmnew.features.viewAllOrder.model.AddOrderInputProductList
import com.utkarshambassadorfsmnew.mappackage.SendBrod
import com.utkarshambassadorfsmnew.widgets.AppCustomTextView
import com.utkarshambassadorfsmnew.MonitorService
import com.utkarshambassadorfsmnew.MySingleton
...
import com.utkarshambassadorfsmnew.features.addshop.presentation.ShopExtraContactReq
...
import com.utkarshambassadorfsmnew.features.login.model.GetConcurrentUserResponse
import com.utkarshambassadorfsmnew.features.login.model.WhatsappApiData
import com.utkarshambassadorfsmnew.features.performance.model.Gps_status_list
import com.utkarshambassadorfsmnew.features.performance.model.UpdateGpsInputListParamsModel
import com.utkarshambassadorfsmnew.features.returnsOrder.ReturnProductList
import com.utkarshambassadorfsmnew.features.returnsOrder.ReturnRequest
import com.utkarshambassadorfsmnew.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmnewlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmnewlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmnewlogsample/log.zip").path);
