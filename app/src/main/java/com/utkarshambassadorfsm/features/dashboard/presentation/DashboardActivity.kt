...
import com.utkarshambassadorfsm.*
import com.utkarshambassadorfsm.R
import com.utkarshambassadorfsm.app.*
import com.utkarshambassadorfsm.app.NewFileUtils.browseDocuments
import com.utkarshambassadorfsm.app.NewFileUtils.browsePDFDocuments
import com.utkarshambassadorfsm.app.NewFileUtils.getExtension
import com.utkarshambassadorfsm.app.domain.*
import com.utkarshambassadorfsm.app.types.DashboardType
import com.utkarshambassadorfsm.app.types.FragType
import com.utkarshambassadorfsm.app.types.TopBarConfig
import com.utkarshambassadorfsm.app.uiaction.DisplayAlert
import com.utkarshambassadorfsm.app.utils.*
import com.utkarshambassadorfsm.app.utils.AppUtils.Companion.isProfile
import com.utkarshambassadorfsm.app.utils.FileLoggingTree.context
...
import com.utkarshambassadorfsm.features.NewQuotation.*
import com.utkarshambassadorfsm.features.NewQuotation.api.GetQuotRegProvider
import com.utkarshambassadorfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.utkarshambassadorfsm.features.SearchLocation.SearchLocationFragment
import com.utkarshambassadorfsm.features.SearchLocation.locationInfoModel
import com.utkarshambassadorfsm.features.TA.ViewAllTAListFragment
import com.utkarshambassadorfsm.features.achievement.AchievementFragment
import com.utkarshambassadorfsm.features.activities.presentation.*
import com.utkarshambassadorfsm.features.addAttendence.*
import com.utkarshambassadorfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.utkarshambassadorfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.utkarshambassadorfsm.features.addAttendence.model.GetReportToFCMResponse
import com.utkarshambassadorfsm.features.addAttendence.model.GetReportToResponse
import com.utkarshambassadorfsm.features.addAttendence.model.Leave_list_Response
import com.utkarshambassadorfsm.features.addorder.presentation.AddOrderFragment
...
import com.utkarshambassadorfsm.features.addshop.presentation.AddShopFragment
import com.utkarshambassadorfsm.features.addshop.presentation.OTPVerificationDialog
import com.utkarshambassadorfsm.features.addshop.presentation.ScanImageFragment
import com.utkarshambassadorfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.utkarshambassadorfsm.features.alarm.model.AlarmData
import com.utkarshambassadorfsm.features.alarm.presetation.AttendanceReportFragment
import com.utkarshambassadorfsm.features.alarm.presetation.PerformanceReportFragment
import com.utkarshambassadorfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.utkarshambassadorfsm.features.alarm.presetation.VisitReportFragment
import com.utkarshambassadorfsm.features.attendance.AttendanceFragment
import com.utkarshambassadorfsm.features.attendance.api.AttendanceRepositoryProvider
import com.utkarshambassadorfsm.features.attendance.model.AttendanceRequest
import com.utkarshambassadorfsm.features.attendance.model.AttendanceResponse
import com.utkarshambassadorfsm.features.averageshop.presentation.AverageShopFragment
import com.utkarshambassadorfsm.features.avgorder.presentation.AverageOrderFragment
import com.utkarshambassadorfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.utkarshambassadorfsm.features.beatCustom.TeamBeatListFragment
import com.utkarshambassadorfsm.features.billing.presentation.AddBillingFragment
import com.utkarshambassadorfsm.features.billing.presentation.BillingDetailsFragment
import com.utkarshambassadorfsm.features.billing.presentation.BillingListFragment
import com.utkarshambassadorfsm.features.changepassword.presentation.ChangePasswordDialog
import com.utkarshambassadorfsm.features.chat.model.ChatListDataModel
import com.utkarshambassadorfsm.features.chat.model.ChatUserDataModel
import com.utkarshambassadorfsm.features.chat.model.GroupUserDataModel
import com.utkarshambassadorfsm.features.chat.presentation.*
import com.utkarshambassadorfsm.features.chatbot.presentation.ChatBotFragment
import com.utkarshambassadorfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.utkarshambassadorfsm.features.chatbot.presentation.ReportsFragment
import com.utkarshambassadorfsm.features.chatbot.presentation.SelectLanguageDialog
import com.utkarshambassadorfsm.features.commondialog.presentation.CommonDialog
import com.utkarshambassadorfsm.features.commondialog.presentation.CommonDialogClickListener
import com.utkarshambassadorfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.utkarshambassadorfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.utkarshambassadorfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.utkarshambassadorfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.utkarshambassadorfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.utkarshambassadorfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.utkarshambassadorfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.utkarshambassadorfsm.features.damageProduct.ShopDamageProductListFrag
import com.utkarshambassadorfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.utkarshambassadorfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.utkarshambassadorfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.utkarshambassadorfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.utkarshambassadorfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.utkarshambassadorfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.utkarshambassadorfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.utkarshambassadorfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.utkarshambassadorfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.utkarshambassadorfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.utkarshambassadorfsm.features.device_info.presentation.DeviceInfoListFragment
import com.utkarshambassadorfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.utkarshambassadorfsm.features.document.DocumentRepoFeatureNewFragment
import com.utkarshambassadorfsm.features.document.presentation.DocumentListFragment
import com.utkarshambassadorfsm.features.document.presentation.DocumentTypeListFragment
import com.utkarshambassadorfsm.features.document.presentation.OpenFileWebViewFragment
import com.utkarshambassadorfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.utkarshambassadorfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.utkarshambassadorfsm.features.dymanicSection.presentation.DynamicListFragment
import com.utkarshambassadorfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.utkarshambassadorfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.utkarshambassadorfsm.features.home.presentation.HomeFragment
import com.utkarshambassadorfsm.features.homelocation.presentation.HomeLocationFragment
import com.utkarshambassadorfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.utkarshambassadorfsm.features.know_your_state.KnowYourStateFragment
import com.utkarshambassadorfsm.features.lead.LeadFrag
import com.utkarshambassadorfsm.features.lead.ViewLeadFrag
import com.utkarshambassadorfsm.features.leaveapplynew.LeaveHome
import com.utkarshambassadorfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.utkarshambassadorfsm.features.localshops.LocalShopListFragment
import com.utkarshambassadorfsm.features.localshops.LocalShopListMapFragment
import com.utkarshambassadorfsm.features.localshops.NearByShopsMapFragment
import com.utkarshambassadorfsm.features.location.*
import com.utkarshambassadorfsm.features.location.api.LocationRepoProvider
import com.utkarshambassadorfsm.features.location.model.*
import com.utkarshambassadorfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.utkarshambassadorfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.utkarshambassadorfsm.features.login.ShopFeedbackEntity
import com.utkarshambassadorfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.utkarshambassadorfsm.features.login.presentation.LoginActivity
import com.utkarshambassadorfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.utkarshambassadorfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.utkarshambassadorfsm.features.marketAssist.MarketAssistTabFrag
import com.utkarshambassadorfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.utkarshambassadorfsm.features.marketAssist.ShopListMarketAssistFrag
import com.utkarshambassadorfsm.features.marketing.presentation.MarketingPagerFragment
import com.utkarshambassadorfsm.features.meetinglist.prsentation.MeetingListFragment
import com.utkarshambassadorfsm.features.member.MapViewForTeamFrag
import com.utkarshambassadorfsm.features.member.model.TeamLocDataModel
import com.utkarshambassadorfsm.features.member.model.TeamShopListDataModel
import com.utkarshambassadorfsm.features.member.presentation.*
import com.utkarshambassadorfsm.features.menuBeat.MenuBeatFrag
import com.utkarshambassadorfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.utkarshambassadorfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.utkarshambassadorfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.utkarshambassadorfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.utkarshambassadorfsm.features.myjobs.model.CustomerDataModel
import com.utkarshambassadorfsm.features.myjobs.presentation.*
import com.utkarshambassadorfsm.features.myorder.presentation.MyOrderListFragment
import com.utkarshambassadorfsm.features.myprofile.presentation.MyProfileFragment
import com.utkarshambassadorfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.utkarshambassadorfsm.features.nearbyshops.model.ShopData
import com.utkarshambassadorfsm.features.nearbyshops.model.ShopListResponse
import com.utkarshambassadorfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.utkarshambassadorfsm.features.nearbyshops.presentation.BeatListFragment
import com.utkarshambassadorfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.utkarshambassadorfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.utkarshambassadorfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.utkarshambassadorfsm.features.newcollection.CollectionDetailsStatusFragment
import com.utkarshambassadorfsm.features.newcollection.CollectionShopListFragment
import com.utkarshambassadorfsm.features.newcollection.NewCollectionListFragment
import com.utkarshambassadorfsm.features.newcollectionreport.*
import com.utkarshambassadorfsm.features.notification.NotificationFragment
import com.utkarshambassadorfsm.features.orderList.NewDateWiseOrderListFragment
import com.utkarshambassadorfsm.features.orderList.NewOrderListFragment
import com.utkarshambassadorfsm.features.orderList.OrderListFragment
import com.utkarshambassadorfsm.features.orderdetail.presentation.OrderDetailFragment
import com.utkarshambassadorfsm.features.orderhistory.ActivityMapFragment
import com.utkarshambassadorfsm.features.orderhistory.OrderhistoryFragment
import com.utkarshambassadorfsm.features.orderhistory.TimeLineFragment
import com.utkarshambassadorfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.utkarshambassadorfsm.features.orderhistory.model.LocationData
import com.utkarshambassadorfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.utkarshambassadorfsm.features.performance.GpsStatusFragment
import com.utkarshambassadorfsm.features.performance.PerformanceFragment
import com.utkarshambassadorfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.utkarshambassadorfsm.features.performance.model.UpdateGpsInputParamsModel
import com.utkarshambassadorfsm.features.performanceAPP.OwnPerformanceFragment
import com.utkarshambassadorfsm.features.performanceAPP.PerformanceAppFragment
import com.utkarshambassadorfsm.features.performanceAPP.allPerformanceFrag
import com.utkarshambassadorfsm.features.permissionList.ViewPermissionFragment
import com.utkarshambassadorfsm.features.photoReg.*
import com.utkarshambassadorfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.utkarshambassadorfsm.features.quotation.presentation.*
import com.utkarshambassadorfsm.features.reimbursement.presentation.*
import com.utkarshambassadorfsm.features.report.presentation.*
import com.utkarshambassadorfsm.features.returnsOrder.*
import com.utkarshambassadorfsm.features.settings.presentation.SettingsFragment
import com.utkarshambassadorfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.utkarshambassadorfsm.features.shopdetail.presentation.*
import com.utkarshambassadorfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.utkarshambassadorfsm.features.stock.StockDetailsFragment
import com.utkarshambassadorfsm.features.stock.StockListFragment
import com.utkarshambassadorfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.utkarshambassadorfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.utkarshambassadorfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.utkarshambassadorfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.utkarshambassadorfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.utkarshambassadorfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.utkarshambassadorfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.utkarshambassadorfsm.features.survey.SurveyFrag
import com.utkarshambassadorfsm.features.survey.SurveyViewDtlsFrag
import com.utkarshambassadorfsm.features.survey.SurveyViewFrag
import com.utkarshambassadorfsm.features.task.presentation.AddTaskFragment
import com.utkarshambassadorfsm.features.task.presentation.CalenderTaskFragment
import com.utkarshambassadorfsm.features.task.presentation.EditTaskFragment
import com.utkarshambassadorfsm.features.task.presentation.TaskListFragment
import com.utkarshambassadorfsm.features.taskManagement.TaskManagementFrag
import com.utkarshambassadorfsm.features.taskManagement.ViewTaskManagementFrag
import com.utkarshambassadorfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.utkarshambassadorfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.utkarshambassadorfsm.features.timesheet.presentation.TimeSheetListFragment
import com.utkarshambassadorfsm.features.viewAllOrder.CartFragment
import com.utkarshambassadorfsm.features.viewAllOrder.OrderTypeListFragment
import com.utkarshambassadorfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.utkarshambassadorfsm.features.viewAllOrder.ViewCartFragment
import com.utkarshambassadorfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.utkarshambassadorfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.utkarshambassadorfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.utkarshambassadorfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.utkarshambassadorfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.utkarshambassadorfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.utkarshambassadorfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.utkarshambassadorfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.utkarshambassadorfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.utkarshambassadorfsm.features.viewPPDDStock.ViewStockFragment
import com.utkarshambassadorfsm.features.weather.presentation.WeatherFragment
import com.utkarshambassadorfsm.mappackage.MapActivity
import com.utkarshambassadorfsm.mappackage.MapActivityWithoutPath
import com.utkarshambassadorfsm.mappackage.SendBrod
import com.utkarshambassadorfsm.widgets.AppCustomEditText
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xutkarshambassadorfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.utkarshambassadorfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xutkarshambassadorfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
